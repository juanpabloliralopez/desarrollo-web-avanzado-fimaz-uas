        ...
        <div class="row mt-3">
          ...
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auo mb-4">
           ...
           <div class="col-md-4 col-lg-3 col-xl-3 mx-auo mb-4">
            ...
            <p>
              <i class="fa-solid  fa-phone"> +52 6699811560</i>
              <i class="fa-solid fa-envelope"> juanpabl0lira1717@gmail.com</i>
              <i class="fa-solid fa-school"> Facultad de Informatica Mazatlan, Universidad Autonoma de Sinaloa.</i>
            </p>
          </div>
        </div>
      </div>
