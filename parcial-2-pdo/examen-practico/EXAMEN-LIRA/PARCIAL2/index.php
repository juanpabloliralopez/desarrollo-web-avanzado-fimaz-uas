...
<head>
    ...
    <title>CRUD productos con PHP PDO Y POO</title>
            ...
            <div class="card-body">
                <form method="POST" action="">
                    ...
                    <?php if ($productoEditar): ?>
                        <a href="index.php" class="btn btn-secondary">Cancelar edicion</a>
                    <?php endif; ?>
                </form>
            </div>
        </div>
                            ...
                            <?php foreach ($productos as $producto) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="index.php?eliminar=<?php echo $producto['id']; ?>" class="btn btn-danger btn-sm"; onclick="return confirm('¿Seguro que deseas eliminar este producto?');">
                                            Eliminar
                                        </a>
                                    </td>
                                </tr>
